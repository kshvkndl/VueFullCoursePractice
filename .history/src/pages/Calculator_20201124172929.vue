<template>
  <section
    class="flex w-full h-screen bg-gradient-to-r from-red-900 to-blue-900"
  >
    <div
      class="m-auto border rounded shadow px-5 py-3 mt-5 bg-gradient-to-r from-gray-900 to-teal-900"
    >
      <h1 class="text-2xl text-center text-gray-600"><u>Calculator</u></h1>
      <p
